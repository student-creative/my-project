        ...
        <div className="">
            ...
            <div className="background-image">
                <div className="relative">
                    ...
                    <div 
                        ...
                        data-aos="fade-up"
                    >
                        <span className="text-white text-base md:text-lg">about us</span>
                        <h1 className="text-white text-3xl md:text-5xl font-bold mt-2">about us</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full h-auto bg-white px-4">
                <div className="max-w-[1140px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        >
                            <img src={require(`../img/${item.img}`)} alt="" className="w-full" />
            ...
            <div className="w-full h-auto py-12 md:py-20 bg-white px-4">
                <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row items-center">
                    <div 
                        className="w-full md:w-[350px] h-auto px-4 mb-8 md:mb-0"
                        data-aos="fade-right"
                    >
                    ...
                    <div 
                        className="w-full md:w-[790px] h-auto"
                        data-aos="fade-left"
                    >
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {['icon2.png', 'icon3.png', 'icon4.png', 'icon5.png', 'icon6.png', 'icon7.png'].map((icon, index) => (
                                <div 
                                    key={index}
                                    className="bg-[#EFF0F3] p-4 shadow-md flex items-center justify-center"
                                    data-aos="zoom-in"
                                    data-aos-delay={index * 100}
                                >
                                    <img src={require(`../img/${icon}`)} alt="icon" className="w-auto h-16 md:h-24" />
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {['doc1.jpg', 'doc2.jpg', 'doc3.jpg', 'doc4.jpg'].map((doc, index) => (
                            <div 
                                ...
                                data-aos-delay={index * 100}
                            >
                                <img src={require(`../img/${doc}`)} alt="" className="w-full" />
            ...
            <div className="w-full h-auto bg-white py-12 md:py-20 px-4">
                <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row items-start gap-8 md:gap-10">
                    ...
                    >
                        <img
                            className="w-full h-[200px] md:h-[300px] object-cover scale-150"
                            src={require('../img/back2.jpg')}
                            alt=""
                        />
                    </div>
                    <div 
                        className="w-full md:w-[540px] h-auto md:h-[320px] px-0"
                        data-aos="fade-left"
                    >
