...
function Home() {
  ...
  <div className="h-screen relative">
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full px-4 max-w-[1140px]">
      <div 
        className="right-side py-12 md:py-24 w-full md:w-[570px]"
        data-aos="fade-right"
      >
        ...
        <p className='pr-0 md:pr-10 mb-3 md:mb-5 text-[#6F8BA4] text-sm md:text-[16px]'>
        ...
        <button className='uppercase text-white bg-[#E12454] px-6 md:px-8 text-xs md:text-sm font-exo font-bold py-2 md:p-3 rounded-full flex items-center gap-2 md:gap-3'>
          <Link to="/appoinment"> Make appointment </Link><i className='text-lg md:text-xl'><BiChevronRight /></i>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center px-4 -mt-10 md:-mt-16">
                {/* Card 1 */}
                <div
                    className="w-full md:w-[350px] h-[350px] bg-white shadow-lg rounded-xl p-6"
                    data-aos="fade-up"
                >
                    <div className="mb-5">
                    ...
                    <button className='uppercase text-white p-3 md:p-4 px-6 md:px-8 font-exo text-xs md:text-[13px] font-bold rounded-full bg-[#223A66] hover:bg-[#E12454] transform duration-300'>
            ...
            <div className="w-full py-12 md:py-24 px-4">
                <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row items-center justify-between">
                    ...
                    >
                        <div>
                            <img className='w-full md:w-[350px] h-[312px] object-cover' src={require('../img/girl.jpg')} alt="" />
                            <img className='w-full md:w-[350px] h-[312px] mt-5 object-cover' src={require('../img/team.jpg')} alt="" />
                        </div>
                        <img className='w-full md:w-[350px] h-[500px] object-cover mt-5 md:mt-0' src={require('../img/doctor.jpg')} alt="" />
                    </div>
                    <div
                        className="w-full md:w-[350px] px-4"
                        data-aos="fade-left"
                    >
                        ...
                        <button className='uppercase text-white bg-[#E12454] px-6 md:px-7 text-xs md:text-sm font-exo font-bold py-2 md:p-3 rounded-full flex items-center gap-2 md:gap-3 hover:bg-[#223A66] transform duration-300'>
            ...
            <div className="w-full py-12 md:py-16  px-4" ref={ref}>
                <div className="max-w-[1140px] mx-auto flex bg-[#223A66] flex-col md:flex-row">
                    <div
                        className="w-full md:w-[277px] py-8 md:py-12 flex flex-col items-center space-y-3 md:space-y-5"
                        data-aos="zoom-in"
                    >
            ...
            <div className="w-full py-12 md:py-20 px-4">
                <div className="max-w-[1140px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
                        {/* Service 1 */}
                        <div
                            className="w-full h-[240px] p-8 md:p-10 bg-white rounded-md"
                            data-aos="zoom-in"
                        >
            ...
            <div className="w-full py-12 md:py-20 bg-white px-4">
                <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row">
                    <div
                        className="w-full md:w-[540px] h-[500px] md:h-[655px] px-4"
                        data-aos="fade-right"
                    >
                    ...
                    <div
                        className="w-full md:w-[540px] px-4 mt-8 md:mt-0"
                        data-aos="fade-left"
                    >
            ...
            <div className="w-full py-12 md:py-20 px-4">
                <div className="max-w-[1140px] mx-auto">
                    ...
                    >
                        ...
                        <p className='text-slate-500 mb-4' data-aos="fade-up" data-aos-delay="200">
                            Lets know moreel necessitatibus dolor asperiores illum possimus sint voluptates incidunt molestias nostrum laudantium. Maiores porro cumque quaerat.
                        </p>
                    </div>
                        ...
                        >
                            <SwiperSlide>
                                <div className="bg-white w-full md:w-[530px] h-auto p-8 md:p-10 rounded-lg flex flex-col md:flex-row items-start gap-4 md:gap-6">
                                    <img src={doctor1} alt="Partho Sarothiasdasda" className="w-16 h-16 md:w-24 md:h-24 rounded-full object-cover" />
                                    <div>
                            ...
                            <SwiperSlide>
                                <div className="bg-white w-full md:w-[530px] h-auto p-8 md:p-10 rounded-lg flex flex-col md:flex-row items-start gap-4 md:gap-6">
                                    <img src={doctor2} alt="Kolis Mullar" className="w-16 h-16 md:w-24 md:h-24 rounded-full object-cover" />
                                    <div>
                            ...
                            <SwiperSlide>
                                <div className="bg-white w-full md:w-[530px] h-auto p-8 md:p-10 rounded-lg flex flex-col md:flex-row items-start gap-4 md:gap-6">
                                    <img src={doctor3} alt="Mullar Sarth" className="w-16 h-16 md:w-24 md:h-24 rounded-full object-cover" />
                                    <div>
                    ...
                    >
                        ...
                        >
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon} alt="Partner 1" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon2} alt="Partner 2" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon3} alt="Partner 3" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon4} alt="Partner 4" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon5} alt="Partner 5" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                            <SwiperSlide className="flex justify-center items-center">
                                <img src={icon6} alt="Partner 6" className="h-16 md:h-24 w-auto grayscale hover:grayscale-0 transition duration-300" />
                            </SwiperSlide>
                        </Swiper>
                    </div>
                </div>
