            ...
            <div className="background-image">
                <div className="relative">
                    ...
                    <div
                        ...
                        data-aos="fade-up"
                    >
                        <span className="text-white text-base md:text-lg">Our services</span>
                        <h1 className="text-white text-3xl md:text-5xl font-bold capitalize mt-2">what we do</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full h-auto py-12 md:py-20 px-4">
                <div className="max-w-[1140px] mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {/* Service Card 1 */}
                        <div
                            className="card1 w-full h-auto shadow-xl my-4 md:my-10 p-6 md:p-10"
                            data-aos="fade-up"
                        >
                            <img src={require('../img/img1.jpg')} alt="" className="w-full" />
                        ...
                        <div
                            ...
                            data-aos-delay="100"
                        >
                            <img src={require('../img/img2.jpg')} alt="" className="w-full" />
                            <h4 className='font-exo font-bold text-xl mb-2 mt-4'>Child care</h4>
                            <p className='text-slate-500'>Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        </div>
                        ...
                        <div
                            ...
                            data-aos-delay="200"
                        >
                            <img src={require('../img/img3.jpg')} alt="" className="w-full" />
                            <h4 className='font-exo font-bold text-xl mb-2 mt-4'>Child care</h4>
                            <p className='text-slate-500'>Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        </div>
                        ...
                        <div
                            ...
                            data-aos-delay="300"
                        >
                            <img src={require('../img/img4.jpg')} alt="" className="w-full" />
                            <h4 className='font-exo font-bold text-xl mb-2 mt-4'>Child care</h4>
                            <p className='text-slate-500'>Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        </div>
                        ...
                        <div
                            ...
                            data-aos-delay="400"
                        >
                            <img src={require('../img/img5.jpg')} alt="" className="w-full" />
                            <h4 className='font-exo font-bold text-xl mb-2 mt-4'>Child care</h4>
                            <p className='text-slate-500'>Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        </div>
                        ...
                        <div
                            ...
                            data-aos-delay="500"
                        >
                            <img src={require('../img/img6.jpg')} alt="" className="w-full" />
                            <h4 className='font-exo font-bold text-xl mb-2 mt-4'>Child care</h4>
                            <p className='text-slate-500'>Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        </div>
                    </div>
