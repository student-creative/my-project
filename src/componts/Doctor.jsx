      ...
      <div className="background-image">
        <div className="relative">
          ...
          <div 
            ...
            data-aos="fade-down"
          >
            <span className="text-white text-base md:text-lg">All Doctors</span>
            <h1 className="text-white text-3xl md:text-5xl font-bold mt-2">Specialized doctors</h1>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto max-w-[1140px]">
          ...
          <div className="flex justify-center">
            <div 
              ...
              data-aos="zoom-in"
            >
              <h2 className='text-[#223A66] text-2xl md:text-[40px] font-exo font-bold'>
                Doctors
              </h2>
              <div className="flex justify-center">
            ...
            <ul className="flex overflow-x-auto gap-3 pb-4 scrollbar-hide font-exo font-bold text-xs sm:text-sm md:text-lg whitespace-nowrap">
              {departments.map((dept, index) => (
                <li
                  ...
                  className={`p-2 md:p-3 cursor-pointer rounded transition-colors ${
                    selectedDept === dept 
                      ? 'bg-[#E12454] text-white' 
                      : 'hover:bg-[#E12454] hover:text-white'
                  }`}
                >
                  {dept}
                </li>
          ...
          >
            {filteredDoctors.map((doc, index) => (
              <div 
                key={`${doc.name}-${index}`} 
                className="bg-white text-center rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300"
                data-aos="fade-up"
              ...
              >
                ...
                />
                <div className="p-4">
                  <h3 className="text-lg md:text-xl font-semibold">{doc.name}</h3>
                  <p className="text-gray-600 text-sm md:text-base">{doc.specialization}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="relative w-full h-auto" data-aos="zoom-in-up">
        ...
        <div className="container max-w-[1140px] mx-auto absolute top-0 left-0 right-0 py-12 md:py-20 px-4">
          <div className="w-full md:w-[635px]">
            ...
            <h2 className="font-exo font-bold text-3xl md:text-5xl text-black mb-4">
              We are pleased to offer you the <span className="text-[#223A66]">chance to have the healthy</span>
            </h2>
            <button 
              className='uppercase text-white p-3 md:p-4 px-6 md:px-10 font-exo text-xs md:text-sm font-bold rounded-full bg-[#E12454] hover:bg-[#223A66] transition duration-300'
            >
