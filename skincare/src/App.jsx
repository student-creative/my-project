...
function App() {
  ...
  return (
    <div className='overflow-x-hidden fade-in-on-scroll'>
      <div className="slider md:w-full md:h-auto bg-[#EFF5E1]">

        {/* Navbar with animation */}
        <div className="navbar w-full h-auto p-5 flex justify-around items-center" data-aos="fade-down">
          ...
          <div className="menu hidden sm:block">
            <ul className='flex gap-14 text-[#2D3B36]'>
              <li data-aos="fade-down" data-aos-delay="100">All Product</li>
              <li data-aos="fade-down" data-aos-delay="200">Serum</li>
              <li data-aos="fade-down" data-aos-delay="300">Sunscreen</li>
              <li data-aos="fade-down" data-aos-delay="400">Bundle</li>
            </ul>
          </div>
