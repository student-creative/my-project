...
function RapidoCab() {
  ...
  const fareConfig = {
    bike: { base: 30, perKm: 8, label: "Bike", icon: "Bike" },
    auto: { base: 50, perKm: 12, label: "Auto", icon: "Auto" },
    car: { base: 100, perKm: 18, label: "Car", icon: "Car" },
  };
  ...
  return (
    <div className="container p-3 mt-4">
      <div
        className="shadow rounded-4 p-4 mx-auto w-100"
              ...
              <div className="d-flex flex-wrap gap-2 justify-content-between">
                {Object.entries(fareConfig).map(([key, { label, icon }]) => (
                  <div
                    ...
                    className={`flex-fill text-center p-3 rounded-3 border ${
                      rideType === key
