      ...
      <div className="w-full my-5 px-3 flex items-center justify-center">
        <div className="relative w-full max-w-7xl h-auto min-h-[800px]" data-aos="zoom-in">
          ...
          <div className="relative z-20 flex flex-col lg:flex-row items-start justify-between gap-8 p-6 lg:p-12 h-full">
            ...
            {/* Booking Form */}
            <div className="w-full lg:w-1/2 bg-black bg-opacity-60 p-6 rounded-lg" data-aos="fade-up">
              ...
              <div className="space-y-3">
                ...
                <input type="email" className="w-full bg-transparent border border-amber-700 p-3 text-white placeholder-white" placeholder="Email" required />
                ...
                <input type="number" className="w-full bg-transparent border border-amber-700 p-3 text-white placeholder-white" placeholder="Person" required />
              </div>
