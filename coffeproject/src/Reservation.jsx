        ...
        <div className="row-table relative">
          ...
          <div className="book-table absolute top-20 px-3 p-5">
            ...
            <div className="flex">
              ...
              <h5 className="mb-3 text-white"> Lorem ipsum dolor sit amet</h5>
            </div>
            <div className="flex">
              <i className='mr-3 text-orange-500'><FaCheck /></i>
              <h5 className="mb-3 text-white"> Lorem ipsum dolor sit amet</h5>
          ...
          <div className="booking absolute top-0 left-1/2 px-3 p-5">
            <h1 className="text-white mb-4 mt-5 text-center text-4xl">Book Your Table</h1>
            <div className="from-group1">
              <div className="form-group">
                <input type="text" className="input bg-transparent border border-amber-700 p-4 text-white mb-2" placeholder="Name" required />
              </div>
              <div className="form-group">
                <input type="text" className="input bg-transparent border border-amber-700 p-4 text-white mb-2" placeholder="Email" required />
              </div>
              <div className="form-group">
                <input type="text" className="input bg-transparent border border-amber-700 p-4 text-white mb-2" placeholder="Date" required />
              </div>
              <div className="form-group">
                <input type="text" className="input bg-transparent border border-amber-700 p-4 text-white mb-2" placeholder="Time" required />
              </div>
              <div className="form-group">
                <input type="text" className="input bg-transparent border border-amber-700 p-4 text-white mb-2" placeholder="Person" required />
              </div>
            </div>
